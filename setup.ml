...
(* OASIS_START *)
(* DO NOT EDIT (digest: b33970869128042b81c204c389c934aa) *)
(*
...
let setup_t =
  {
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, ["-Wall"; "-O3"])];
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "test";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "oPasswd"];
                      bs_build_tools =
     ...
     oasis_version = "0.3.0";
     oasis_digest =
       Some "\246w\011q\163\019\164\200\209@\174\025\187\141\222\189";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
